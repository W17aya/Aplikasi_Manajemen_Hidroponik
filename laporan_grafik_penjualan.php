...
<?php include 'header.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Laporan Grafik Hasil Penjualan</h1>
           </div>
<!--
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Grafik Hasil Penjualan</h6>
                  
                </div>
             
                <div class="card-body ">
                  <form action="grafik_hasil_penjualan.php" method="get" target="_blank">
...
<input type="submit" name="grafik_hasil_penjualan" class="btn btn-primary" value="Tampilkan">
  </form>
