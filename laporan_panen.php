...
<?php include 'header.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Laporan Hasil Panen</h1>
           </div>
<!--
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Hasil Panen</h6>
                  
                </div>
             
                <div class="card-body ">
                  <form action="cetak_hasil_panen.php" method="get" target="_blank">
<table class="table">
  <tr>
  <td>
  ...
  <tr>
    ...
    <td></td>
    <td>
      <input type="submit" name="cetak_hasil_panen" class="btn btn-primary" value="cetak">
    </td>
  </tr>
