...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Hasil Panen</h1>
                      </div>

        
        <!-- Content Row -->
          <div class="d-sm-flex align-items-center justify-content-between mb-2">
          <a href="<?='input_panen.php'; ?>" style="margin-bottom:20px" class="btn btn-primary col-md-2"><span class="fas fa-plus fa-sm text-white-50"></span> Tambah Data</a>
  ...
  <?php include 'connection.php';
          ...
          ORDER BY kode_panen ASC"); 
            ...
            while($data = mysqli_fetch_array($result)){ 
                ...
                <tr align="center">
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $data['kode_panen']; ?></td>
                    <td><?php echo $data['kode_penanaman']; ?></td>
                    <td><?php echo Indonesia2Tgl($data['tanggal_panen']); ?></td>
                    <td><?php echo $data['nama_tanaman']; ?></td>
                    <td><?php echo number_format($data['jumlah']); ?></td>
                    <td>

                    <a href="hapus_panen.php?id=<?php echo $data['kode_panen'];?>"
