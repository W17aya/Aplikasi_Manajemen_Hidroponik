...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Hasil Penjualan</h1>
                      </div>

        
        <!-- Content Row -->
          <div class="d-sm-flex align-items-center justify-content-between mb-2">
          <a href="<?='input_penjualan.php'; ?>" style="margin-bottom:20px" class="btn btn-primary col-md-2"><span class="fas fa-plus fa-sm text-white-50"></span> Tambah Data</a>
...
<!-- Search -->
  ...
  <?php include 'connection.php';
          ...
          JOIN tanaman ON penjualan.kode_tanaman = tanaman.kode_tanaman
          ORDER BY kode_penjualan ASC"); 
            ...
            while($data = mysqli_fetch_array($result)){ 
                ...
                <tr align="center">
                    ...
                    <td><?php echo Indonesia2Tgl($data['tanggal_jual']); ?></td>
                    <td>
                    <a href="cetak_nota.php?id=<?php echo $data['kode_penjualan'];?>"
      class="fas fa-download fa-sm text-blue-50" title="Cetak Nota"></a>
                    <a href="detail_penjualan.php?id=<?php echo $data['kode_penjualan'];?>"
      class="fas fa-search-plus fa-sm text-blue-50" title="Rincian"></a>
                    <a href="hapus_penjualan.php?id=<?php echo $data['kode_penjualan'];?>"
